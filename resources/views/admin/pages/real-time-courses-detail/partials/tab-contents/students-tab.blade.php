<div class="tab-pane fade" id="students" role="tabpanel" aria-labelledby="students-tab">
    <div class="col-lg-12 col-md-9 col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="p-4 d-flex justify-content-between align-items-center">
                ...
                <div class="nav btn-group flex-nowrap" role="tablist">
                    <button class="btn btn-outline-secondary" data-bs-toggle="tab" data-bs-target="#tabPaneGridStudent"
        ...
        <div class="tab-content">
            <div class="tab-pane fade pb-4" id="tabPaneGridStudent" role="tabpanel"
                aria-labelledby="tabPaneGridStudent">
                <div class="row">
            ...
            <!-- Tab pane -->
            <div class="tab-pane fade" id="tabPaneListStudent" role="tabpanel" aria-labelledby="tabPaneListStudent">
                <div class="card">
