...
<div class="modal fade" id="editCourseCategoryParent" tabindex="-1" aria-labelledby="editCourseCategoryParentLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title mb-0" id="editCourseCategoryParentLabel">
            ...
            <div class="modal-body">
                <form id="editCourseCategoryParentForm" method="POST" enctype="multipart/form-data"
...
<script>
    ...
    $(document).on('show.bs.modal', '#editCourseCategoryParent', function(e) {
