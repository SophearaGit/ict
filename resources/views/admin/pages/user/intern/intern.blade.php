...
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="border-bottom pb-3 mb-3 d-flex justify-content-between align-items-center">
                ...
                <div class="nav btn-group" role="tablist">
                    ...
                    <button class="btn btn-primary add_intern_btn">
                ...
                <div class="tab-pane fade" id="tabPaneGrid" role="tabpanel" aria-labelledby="tabPaneGrid">
                    <div class="mb-4">
                        <form action="{{ route('admin.intern.index') }}" method="GET">
                            <input type="search" class="form-control" placeholder="Search Intern" name="search"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <h4 class="mb-0">No interns found.</h4>
                                        <p class="mb-0">There are currently no approved interns with uploaded
                                            documents.</p>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="hstack gap-4">
                                                    <span class="dropdown dropstart">
                                                        ...
                                                        <span class="dropdown-menu">
                                                            ...
                                                            @if ($intern->role == 'unknown')
                                                                <form
                                                                    action="{{ route('admin.intern.toggle', $intern->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PATCH')
                                                                    <button type="submit" class="dropdown-item">
                                                            ...
                                                            @endif
                                                            <a class="dropdown-item edit_intern_btn"
                                                                href="javascript:void(0)" data-id="{{ $intern->id }}">
                                                                <i class="fe fe-edit dropdown-item-icon"></i>
                                                                Edit
                                                            </a>
                                                            <a class="dropdown-item del_intern_btn"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center">
                                                <h5 class="mb-0">No interns found.</h5>
                                                <p class="mb-0">There are currently no approved interns with
    ...
    <div class="modal fade" id="dynamic_intern_modal" tabindex="-1" aria-labelledby="addInternModalLabel"
        aria-hidden="true">
        <div class="modal-dialog dynamic_intern_modal_content">
...
@push('scripts')
    <script>
        $('.add_intern_btn').on('click', function(e) {
            e.preventDefault();
            $('#dynamic_intern_modal').modal('show');
            $.ajax({
                method: 'GET',
                url: base_url + `/intern/create`,
                data: {},
                beforeSend: function() {
                    $('.dynamic_intern_modal_content').html(
                ...
                success: function(data) {
                    $('.dynamic_intern_modal_content').html(data);
                },
        ...
        $('.edit_intern_btn').on('click', function(e) {
            e.preventDefault();
            $('#dynamic_intern_modal').modal('show');
            let intern_id = $(this).data('id');
            $.ajax({
                method: 'GET',
                url: base_url + `/intern/edit/${intern_id}`,
                data: {},
                beforeSend: function() {
                    $('.dynamic_intern_modal_content').html(
                        `<div class="d-flex justify-content-center align-items-center" style="height: 200px;">
        ...
        $('.del_intern_btn').on('click', function(e) {
            e.preventDefault();
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const activeTab = localStorage.getItem('intern_active_tab') || 'grid';
        ...
        document.querySelectorAll('[data-tab]').forEach(btn => {
            btn.addEventListener('click', function() {
                localStorage.setItem('intern_active_tab', this.dataset.tab);
            });
        });
    </script>
@endpush
