...
<head>
    <meta charset="utf-8" />
    <title>ICT INTERN DASHBOARD</title>
        ...
        <div class="sidenav-menu">
            ...
            <a href="{{ route('home') }}" class="logo">
                <span class="logo-light">
                    ...
                    <span class="logo-sm text-center"><img src="/frontend/intern/assets/images/logo-sm.png"
                            alt="small logo"></span>
                </span>
                <span class="logo-dark">
                    <span class="logo-lg"><img src="/frontend/intern/assets/images/logo-dark.png"
                            alt="dark logo"></span>
                    <span class="logo-sm text-center"><img src="/frontend/intern/assets/images/logo-sm.png"
                            alt="small logo"></span>
                </span>
            ...
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="index.html" class="logo">
                        <span class="logo-light">
                            <span class="logo-lg"><img src="/frontend/intern/assets/images/logo.png"
                                    alt="logo"></span>
                            <span class="logo-sm"><img src="/frontend/intern/assets/images/logo-sm.png"
                                    alt="small logo"></span>
                        </span>
                        <span class="logo-dark">
                            <span class="logo-lg"><img src="/frontend/intern/assets/images/logo-dark.png"
                    ...
                    <div class="topbar-item">
                        <div class="dropdown">
                            <button class="topbar-link btn btn-outline-primary btn-icon" data-bs-toggle="dropdown"
                                ...
                                <img src="/frontend/intern/assets/images/flags/us.svg" alt="user-image"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="hi">
                                    <img src="/frontend/intern/assets/images/flags/in.svg" alt="user-image"
                                        class="me-1 rounded" height="18" data-translator-image> <span
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="/frontend/intern/assets/images/flags/de.svg" alt="user-image"
                                        class="me-1 rounded" height="18"> <span class="align-middle">German</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="/frontend/intern/assets/images/flags/it.svg" alt="user-image"
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="/frontend/intern/assets/images/flags/es.svg" alt="user-image"
                                        class="me-1 rounded" height="18"> <span
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="/frontend/intern/assets/images/flags/ru.svg" alt="user-image"
                                        class="me-1 rounded" height="18"> <span
                            ...
                            <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg"
                                ...
                                <div class="position-relative z-2 rounded-0" style="max-height: 300px;"
                                    ...
                                    <div class="dropdown-item notification-item py-2 text-wrap active"
                                        ...
                                        <span class="d-flex align-items-center">
                                            <span class="me-3 position-relative flex-shrink-0">
                                                <img src="/frontend/intern/assets/images/users/avatar-2.jpg"
                                    ...
                                    <div class="dropdown-item notification-item py-2 text-wrap" id="notification-2">
                                        <span class="d-flex align-items-center">
                                            <span class="me-3 position-relative flex-shrink-0">
                                                <img src="/frontend/intern/assets/images/users/avatar-4.jpg"
                                                    class="avatar-md rounded-circle" alt="" />
                                                <span
                                    ...
                                    <div class="dropdown-item notification-item py-2 text-wrap" id="notification-4">
                                        <span class="d-flex align-items-center">
                                            <span class="me-3 position-relative flex-shrink-0">
                                                <img src="/frontend/intern/assets/images/users/avatar-7.jpg"
                                                    class="avatar-md rounded-circle" alt="" />
                                                <span
                                    ...
                                    <div class="dropdown-item notification-item py-2 text-wrap" id="notification-5">
                                        <span class="d-flex align-items-center">
                                            <span class="me-3 position-relative flex-shrink-0">
                                                <img src="/frontend/intern/assets/images/users/avatar-10.jpg"
                                                    class="avatar-md rounded-circle" alt="" />
                                                <span
                                                    class="position-absolute rounded-pill bg-danger notification-badge">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg p-0">
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/slack.svg"
                                                    alt="slack">
                                                <span>Slack</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/gitlab.svg"
                                                    alt="Github">
                                                <span>Gitlab</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/dribbble.svg"
                                                    alt="dribbble">
                                                <span>Dribbble</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/bitbucket.svg"
                                                    alt="bitbucket">
                                                <span>Bitbucket</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/dropbox.svg"
                                                    alt="dropbox">
                                                <span>Dropbox</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/google-cloud.svg"
                                                    alt="G Suite">
                                                <span>G Cloud</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/aws.svg"
                                                    alt="bitbucket">
                                                <span>AWS</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/digital-ocean.svg"
                                                    alt="dropbox">
                                                <span>Server</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="/frontend/intern/assets/images/brands/bootstrap.svg"
                                                    alt="G Suite">
                                                <span>Bootstrap</span>
                                            </a>
                                        </div>
                    ...
                    <div class="topbar-item">
                        <div class="dropdown">
                            <a class="topbar-link btn btn-outline-primary dropdown-toggle drop-arrow-none"
                                ...
                                aria-haspopup="false" aria-expanded="false">
                                <img src="/frontend/intern/assets/images/users/avatar-1.jpg" width="24"
                                    ...
                                    <div class="bg-danger bg-opacity-10">
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-3 col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span
                                                        class="ti ti-square-rounded-arrow-up text-danger me-1"></span>
                                                    <span>$15.07k</span>
                                                </h4>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-md flex-shrink-0 me-2">
                                                                    <span
                                                                        ...
                                                                        <img src="/frontend/intern/assets/images/products/logo/logo-1.svg"
                                                                            alt="" height="22">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-md flex-shrink-0 me-2">
                                                                    <span
                                                                        ...
                                                                        <img src="/frontend/intern/assets/images/products/logo/logo-4.svg"
                                                                            alt="" height="22">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-md flex-shrink-0 me-2">
                                                                    <span
                                                                        ...
                                                                        <img src="/frontend/intern/assets/images/products/logo/logo-5.svg"
                                                                            alt="" height="22">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-md flex-shrink-0 me-2">
                                                                    <span
                                                                        ...
                                                                        <img src="/frontend/intern/assets/images/products/logo/logo-6.svg"
                                                                            alt="" height="22">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-md flex-shrink-0 me-2">
                                                                    <span
                                                                        class="avatar-title bg-primary-subtle rounded-circle">
                                                                        <img src="/frontend/intern/assets/images/products/logo/logo-8.svg"
                                                                            alt="" height="22">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                                    <span
                                                                        class="text-muted fs-12">Manufacturing</span>
                                                                    <br />
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="/frontend/intern/assets/images/products/p-1.png"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="/frontend/intern/assets/images/products/p-7.png"
                                                                    alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="/frontend/intern/assets/images/products/p-4.png"
                                                                    alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="/frontend/intern/assets/images/products/p-5.png"
                                                                    alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="/frontend/intern/assets/images/products/p-6.png"
                                                                    alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="/frontend/intern/assets/images/products/p-6.png" alt="product-pic"
                                            height="36">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="/frontend/intern/assets/images/products/p-1.png" alt="product-pic"
                                            height="36">
                                    </div>
                                    <div>
                                        <h5 class="fs-14 my-1"><a href="apps-ecommerce-order-details.html"
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="/frontend/intern/assets/images/products/p-3.png" alt="product-pic"
                                            height="36">
                                    </div>
                                    <div>
                                        <h5 class="fs-14 my-1"><a href="apps-ecommerce-order-details.html"
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="/frontend/intern/assets/images/products/p-4.png" alt="product-pic"
                                            height="36">
                                    </div>
                                    <div>
                                        <h5 class="fs-14 my-1"><a href="apps-ecommerce-order-details.html"
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="/frontend/intern/assets/images/products/p-2.png" alt="product-pic"
                                            height="36">
                                    </div>
                                    <div>
                                        <h5 class="fs-14 my-1"><a href="apps-ecommerce-order-details.html"
                            ...
                            <div class="card-body">
                                <div class="card mb-0 bg-warning bg-opacity-25">
                                    <div class="card-body"
                                        style="background-image: url(/frontend/intern/assets/images/png/arrows.svg); background-size: contain; background-repeat: no-repeat; background-position: right bottom;">
                                        <h1><i class="ti ti-receipt-tax text-warning"></i></h1>
                                        <h4 class="text-warning">Estimated tax for this year</h4>
                                        <p class="text-warning text-opacity-75">We kindly encourage you to review your
