  ...
  <div class="item">
    <div class="stat-card shadow-sm" style="background:#fdf2f8;">
      <div class="stat-icon" style="background:#fce7f3;">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#db2777" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="item">
    <div class="stat-card shadow-sm" style="background:#fffbeb;">
      <div class="stat-icon" style="background:#fef3c7;">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#d97706" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="item">
    <div class="stat-card shadow-sm" style="background:#f0fdf4;">
      <div class="stat-icon" style="background:#dcfce7;">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#16a34a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="{{ route('staff.courses.show', $course->id) }}" class="text-decoration-none">
          <div class="card course-card shadow-sm">
            ...
            <div class="banner-wrap">
              <img src="{{ asset($course->thumbnail == '' ? '/default-images/staff/no-course-img.png' : $course->thumbnail) }}" class="card-img" alt="{{ $course->title }}">
            ...
            <div class="card-content">
              ...
              <div class="avatar-overlap">
                <img src="{{ asset($course->instructor->image == 'no-img.jpg' ? '/default-images/user/both.jpg' : $course->instructor->image) }}" alt="{{ $course->instructor->name }}" title="{{ $course->instructor->name }}">
              </div>
              {{-- Course title --}}
      ...
      <div class="card-body p-4">
        ...
        <div class="d-flex flex-column gap-2">
          ...
          <a href="{{ route('staff.courses.show', $course->id) }}" class="recent-card">
            <img src="{{ asset($course->thumbnail == '' ? '/default-images/staff/no-course-img.png' : $course->thumbnail) }}" alt="{{ $course->title }}">
            ...
            @elseif ($course->status == 'draft')
            <span class="badge rounded-pill"
                                        style="background:#f8fafc;color:#94a3b8;font-size:.65rem;font-weight:700;height:fit-content;white-space:nowrap;">DRAFT</span>
            @else
            <span class="badge rounded-pill"
      ...
      <div class="card-body p-4">
        ...
        <div class="d-flex flex-column gap-2">
          ...
          <div class="teacher-card">
            <img class="avatar" src="{{ asset($teacher->image == 'no-img.jpg' ? '/default-images/user/both.jpg' : $teacher->image) }}" alt="{{ $teacher->name }}">
            <div class="flex-grow-1 min-w-0">
