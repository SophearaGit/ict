...
<head>
    ...
    {{-- tinymce --}}
    {{-- <script src="https://cdn.tiny.cloud/1/uiukjattvwazv3xqo1ufdwpi9bzfjvr48jr2cztyjhf79m1v/tinymce/8/tinymce.min.js"
        referrerpolicy="origin" crossorigin="anonymous"></script> --}}

    <link rel="stylesheet" href="/admin/assets/dist/libs/sweetalert2/dist/sweetalert2.min.css">
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-theme="blue_theme" data-layout="vertical" data-sidebartype="full"
        ...
        @include('frontend.staff.layout.partials.sidebar')
        <!--  Main wrapper -->
        <div class="body-wrapper">
            @include('frontend.staff.layout.partials.header')
            ...
            <ul class="mb-0">
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="/admin/assets/dist/images/products/product-1.jpg" width="95" height="75"
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="/admin/assets/dist/images/products/product-2.jpg" width="95" height="75"
                            class="rounded-1 me-9 flex-shrink-0" alt="" />
                        <div>
                            <h6 class="mb-1">Supreme toys cooker</h6>
                            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="/admin/assets/dist/images/products/product-3.jpg" width="95" height="75"
                            class="rounded-1 me-9 flex-shrink-0" alt="" />
                        <div>
                            <h6 class="mb-1">Supreme toys cooker</h6>
                            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar"
        ...
        <nav class="sidebar-nav scroll-sidebar">
            <div class="offcanvas-header justify-content-between">
                <img src="/admin/assets/dist/images/logos/favicon.ico" alt="" class="img-fluid">
                        ...
                        <ul aria-expanded="false" class="collapse first-level my-3">
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        ...
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-chat.svg" alt=""
                            ...
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-invoice.svg" alt=""
                                            class="img-fluid" width="24" height="24">
                                    </div>
                                    <div class="d-inline-block">
                            ...
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-mobile.svg" alt=""
                                            class="img-fluid" width="24" height="24">
                                    </div>
                                    <div class="d-inline-block">
                            ...
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-message-box.svg"
                            ...
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-cart.svg" alt=""
                                            class="img-fluid" width="24" height="24">
                                    </div>
                                    <div class="d-inline-block">
                            ...
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-date.svg" alt=""
                                            class="img-fluid" width="24" height="24">
                                    </div>
                                    <div class="d-inline-block">
                            ...
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-lifebuoy.svg" alt=""
                                            class="img-fluid" width="24" height="24">
                                    </div>
                                    <div class="d-inline-block">
                            ...
                            <li class="sidebar-item py-2">
                                <a href="#" class="d-flex align-items-center">
                                    <div
                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                        <img src="/admin/assets/dist/images/svgs/icon-dd-application.svg"
                                            alt="" class="img-fluid" width="24" height="24">
                                    </div>
                                    <div class="d-inline-block">
        ...
        <div class="offcanvas-body p-4">
            <div class="theme-option pb-4">
                ...
                <div class="d-flex align-items-center gap-3 my-3">
                    <a href="javascript:void(0)" onclick="toggleTheme('/admin/assets/dist/css/style.min.css')"
                        class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 light-theme text-dark">
                        <i class="ti ti-brightness-up fs-7 text-primary"></i>
                        <span class="text-dark">Light</span>
                    </a>
                    <a href="javascript:void(0)" onclick="toggleTheme('/admin/assets/dist/css/style-dark.min.css')"
                    ...
                    <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('/admin/assets/dist/css/style.min.css')" data-color="blue_theme"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('/admin/assets/dist/css/style-aqua.min.css')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('/admin/assets/dist/css/style-purple.min.css')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('/admin/assets/dist/css/style-green.min.css')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('/admin/assets/dist/css/style-cyan.min.css')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('/admin/assets/dist/css/style-orange.min.css')"
