...
<div class="row">
  <div class="col-12">
    <div class="card course-card">
      <div class="card-body p-4">
        ...
        <form action="{{ route('staff.courses.update', $course) }}" method="POST" enctype="multipart/form-data" id="courseForm">
          @csrf
          @method('PUT')
          ...
          <div class="form-section">
            <div class="row g-3 align-items-start">
              ...
              <div class="col-md-4">
                <div class="rounded p-3" style="background:var(--bs-light);border-radius:var(--form-radius)!important;font-size:12px;color:var(--bs-secondary-color);line-height:1.7;">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" class="form-control" placeholder="Course Title" name="title" id="title" value="{{ old('title', $course->title) }}" required>
                  <label for="title">
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" class="form-control" placeholder="ឈ្មោះវគ្គសិក្សា" name="khmer_title" id="khmer_title" value="{{ old('khmer_title', $course->khmer_title) }}">
              ...
              <div class="col-md-12">
                <div class="form-floating">
                  <input type="url" class="form-control" placeholder="https://t.me/your-group" name="telegram_group_link" id="telegram_group_link" value="{{ old('telegram_group_link', $course->telegram_group_link) }}">
          ...
          <div class="form-section">
            <div class="row g-3">
              ...
              <div class="col-md-3">
                ...
                <select class="form-select select2-instructor" name="instructor_id" id="instructor_id">
                  ...
                  <option value="{{ $instructor->id }}" data-image="{{ $instructor->image == 'no-img.jpg' ? asset('/default-images/user/both.jpg') : asset($instructor->image) }}" {{ old('instructor_id', $course->instructor_id) == $instructor->id ? 'selected' : '' }}>
                    {{ $instructor->name }}
                  </option>
                  @endforeach
                </select>
              ...
              <div class="col-md-3">
                ...
                <select class="form-select select2-category" name="category_id" id="category_id">
                  ...
                  <option value="{{ $category->id }}" data-icon="{{ $category->icon ?? 'ti ti-category' }}" {{ old('category_id', $course->category_id) == $category->id ? 'selected' : '' }}>
                    {{ $category->name }}
                  </option>
                  @endforeach
                </select>
              ...
              <div class="col-md-4">
                ...
                <select class="form-select select2-schedule" name="schedule_id">
                  ...
                  <optgroup label="{{ Str::title(str_replace('-', ' • ', $studyDay)) }}">
                    ...
                    <option value="{{ $schedule->id }}" data-shift="{{ strtolower($schedule->shift) }}" data-start="{{ \Carbon\Carbon::parse($schedule->start_time)->format('g:i') }}" data-end="{{ \Carbon\Carbon::parse($schedule->end_time)->format('g:i A') }}" @selected(old('schedule_id', $course->schedule_id) == $schedule->id)>
              ...
              <div class="col-md-2">
                ...
                <select class="form-select" name="status" id="status" style="border-radius:var(--form-radius);height:42px;">
            ...
            {{-- Featured toggle --}}
            <div class="featured-toggle {{ old('featured', $course->featured) ? 'is-checked' : '' }}" id="featuredToggle">
              <div class="ft-copy">
              ...
              <div class="form-check form-switch mb-0">
                <input class="form-check-input" type="checkbox" role="switch" id="featured" name="featured" value="1" {{ old('featured', $course->featured) ? 'checked' : '' }}>
              </div>
            </div>
          </div>
      </div>
  ...
  <div class="form-section">
    ...
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="start_date" name="start_date" placeholder="Pick a date…" value="{{ old('start_date', optional($course->start_date)->format('Y-m-d')) }}" autocomplete="off">
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="end_date" name="end_date" placeholder="Pick a date…" value="{{ old('end_date', optional($course->end_date)->format('Y-m-d')) }}" autocomplete="off">
        <x-input-error :messages="$errors->get('end_date')" class="text-danger mt-1" />
      </div>
      {{-- Price --}}
      <div class="col-md-3">
        <div class="form-floating">
          <input type="number" class="form-control" placeholder="0.00" name="price" id="price" step="0.01" min="0" value="{{ old('price', $course->price) }}" required>
          <label for="price">
      ...
      <div class="col-md-3">
        <div class="form-floating">
          <select class="form-select" name="price_per_session" id="price_per_session">
            ...
            @for ($i = 5; $i <= 10; $i +=0.5) <option value="{{ number_format($i, 2) }}" @selected(old('price_per_session', $course->price_per_session) == number_format($i, 2))>
              {{ number_format($i, 2) }} $
              </option>
              @endfor
          </select>
    ...
    <div class="row g-3">
      <div class="col-md-3">
        <div class="form-floating">
          <input type="number" class="form-control" placeholder="0" name="duration" id="duration" step="0.5" min="0" value="{{ old('duration', $course->duration) }}">
          <label for="duration">
      ...
      <div class="col-md-3">
        <div class="form-floating">
          <input type="number" class="form-control" placeholder="0" name="capacity" id="capacity" min="1" step="1" value="{{ old('capacity', $course->capacity) }}">
          <label for="capacity">
  ...
  <div class="form-section">
    <textarea class="form-control" name="description" id="description" placeholder="Write a clear, concise course description…" style="min-height:160px;border-radius:var(--form-radius);resize:vertical;">{!! old('description', $course->description) !!}</textarea>
