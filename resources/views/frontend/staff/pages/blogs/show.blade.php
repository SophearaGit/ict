    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-2">
        <div class="d-flex flex-wrap align-items-center gap-2">
            ...
            <span
                ...
                <i
                    class="ti ti-{{ $blog->status === 'published' ? 'circle-check' : 'pencil' }} me-1"></i>{{ ucfirst($blog->status) }}
            </span>
            @if ($blog->is_featured)
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('staff.blogs.edit', $blog) }}" class="btn btn-primary">
                ...
                <div class="card mb-4">
                    <div class="card-body text-center py-5">
                        ...
                        <a href="{{ $blog->embed_url }}" target="_blank" class="btn btn-outline-primary">
                            <i class="ti ti-external-link me-1"></i> Open on {{ ucfirst($blog->type) }}
                        </a>
                    </div>
                </div>
            ...
            @if ($blog->meta_title || $blog->meta_description)
                <div class="card mt-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="ti ti-search me-1"></i> SEO Preview</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mb-4">
                ...
                <div class="list-group list-group-flush">
                    <div class="list-group-item d-flex align-items-center justify-content-between">
                        <span class="text-body"><i class="ti ti-user me-2"></i>Author</span>
                        <span class="fw-medium">{{ $blog->author()?->name ?? '—' }}</span>
                    </div>
                    <div class="list-group-item d-flex align-items-center justify-content-between">
                        <span class="text-body"><i class="ti ti-eye me-2"></i>Views</span>
                        <span class="fw-medium">{{ number_format($blog->views) }}</span>
                    </div>
                    <div class="list-group-item d-flex align-items-center justify-content-between">
                        <span class="text-body"><i class="ti ti-calendar-check me-2"></i>Published</span>
                        <span class="fw-medium">{{ $blog->published_at?->format('M d, Y') ?? '—' }}</span>
                    </div>
                    <div class="list-group-item d-flex align-items-center justify-content-between">
                        <span class="text-body"><i class="ti ti-clock me-2"></i>Last Updated</span>
                        <span class="fw-medium">{{ $blog->updated_at->format('M d, Y') }}</span>
                    </div>
                    <div class="list-group-item">
                        <span class="text-body d-block mb-1"><i class="ti ti-link me-2"></i>Slug</span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ $blog->is_embed_html ? '#' : $blog->embed_url }}"
                            ...
                            <i class="ti ti-brand-{{ $blog->type }} me-1"></i>
