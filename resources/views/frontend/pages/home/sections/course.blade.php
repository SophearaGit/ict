                ...
                <ul class="nav nav-lb-tab mb-6 bg-gray-200 px-5 rounded-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-design-tab" data-bs-toggle="pill" href="#pills-design"
                            role="tab" aria-controls="pills-design" aria-selected="false" tabindex="-1">Design</a>
                    </li>
                    <!-- nav item -->
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-marketing-tab" data-bs-toggle="pill" href="#pills-marketing"
                            role="tab" aria-controls="pills-marketing" aria-selected="false" tabindex="-1">
                            Marketing
                        </a>
                    </li>
                    <!-- nav item -->
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-health-tab" data-bs-toggle="pill" href="#pills-health"
                            role="tab" aria-controls="pills-health" aria-selected="false" tabindex="-1">Health</a>
                    </li>
                </ul>
                <!-- Tab content -->
                    ...
                    <div class="tab-pane fade show active" id="pills-development" role="tabpanel"
                        ...
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-javascript.jpg" alt="course"
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-css.jpg" alt="course"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-gatsby.jpg" alt="course"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-wordpress.jpg" alt="course"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-react.jpg" alt="course"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-graphql.jpg" alt="course"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-angular.jpg" alt="course"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-python.jpg" alt="card"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="tab-pane fade" id="pills-design" role="tabpanel" aria-labelledby="pills-design-tab">
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-hover">
                                    <a href="../course-single.html"><img
                                            src="/frontend/assets/images/course/course-python.jpg" alt="course"
                                            class="card-img-top"></a>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
