            ...
            <div class="col-lg-6 col-12 d-none d-lg-block">
                <div class="d-flex justify-content-center">
                    ...
                    <div class="position-relative">
                        <img src="/frontend/assets/images/png/cta-instructor-1.png" alt="image"
                            class="img-fluid mt-n8" />
                        <div class="ms-n8 position-absolute bottom-0 start-0 mb-6">
                            <img src="/frontend/assets/images/svg/dollor.svg" alt="dollor" />
                        </div>
                        <!-- img -->
                        <div class="me-n4 position-absolute top-0 end-0">
                            <img src="/frontend/assets/images/svg/graph.svg" alt="graph" />
                        </div>
                    </div>
                </div>
            </div>
