                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="5"
                            placeholder="Write a detailed description of your course."></textarea>
...
@push('scripts')
    <script>
        const store_course_basic_info_url = base_url + '/instructor/courses/create';
        ...
        $('.basic_info_form').on('submit', function(e) {
            ...
            $.ajax({
                method: 'POST',
                url: store_course_basic_info_url,
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function() {
