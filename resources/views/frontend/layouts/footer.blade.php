    ...
    <div class="container mt-lg-2">
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <!-- about company -->
                <div class="mb-4">
                    <img src="" alt="ICT FOOTER LOGO" class="logo-inverse" />
                    <div class="mt-4">
            ...
            <div class="col-lg-3 col-md-12">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex">
                        <a href="#"><img src="/frontend/assets/images/svg/appstore.svg" alt=""
                                class="img-fluid" /></a>
                        <a href="#" class="ms-2"><img src="/frontend/assets/images/svg/playstore.svg"
